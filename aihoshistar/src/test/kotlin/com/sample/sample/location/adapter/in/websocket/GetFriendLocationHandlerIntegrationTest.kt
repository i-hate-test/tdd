package com.aihoshistar.sample.location.adapter.`in`.websocket

import com.aihoshistar.sample.location.domain.model.RequestFriendLocation
import com.aihoshistar.sample.location.domain.vo.LocationRequestType
import com.aihoshistar.sample.test.BaseIntegrationTest
import com.aihoshistar.sample.user.USER_ID_1_TOKEN
import com.aihoshistar.sample.user.adapter.out.persistence.jpa.UserFriendRepository
import com.aihoshistar.sample.user.adapter.out.persistence.jpa.UserRepository
import com.aihoshistar.sample.user.makeUserEntity
import com.aihoshistar.sample.user.makeUserFriendEntity
